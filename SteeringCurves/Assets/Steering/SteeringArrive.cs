...
public class SteeringArrive : SteeringAbstract
{
    ...
    public void Steer(Vector3 target)
    {
        ...
        if (distance.magnitude < min_distance && move.current_velocity.magnitude > Vector3.zero.magnitude)
        {
        ...
        else
        {
            ...
            Vector3 actual = move.current_velocity;
            ...
            move.AccelerateMovement(acceler,priority);
